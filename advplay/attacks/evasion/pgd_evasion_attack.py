...
class FGSMEvasionAttack(EvasionAttack, attack_type=available_attacks.EVASION, attack_subtype=evasion_techniques.PGD):
    ATTACK_PARAMETERS = {
    ...
    def execute(self):
        super().execute()
        perturbed_samples = self.art_evasion(ProjectedGradientDescent, eps=self.eps, eps_step=self.eps_step,
