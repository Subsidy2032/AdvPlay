...
class PGDEvasionEvaluator(BaseAttackEvaluator,
    ...
    def _build_visualization_context(clean_samples, adversarial_samples, true_labels,
        ...
        return PGDEvasionVisualizationContext(
            base_accuracy=None,
            targeted=targeted,
    ...
    def _print_summary(results):
        print("PGD evasion evaluation summary:")
        ...
        print(f"  Avg drop in original class:   {results['average_confidence_drop'] * 100:6.2f}%")
