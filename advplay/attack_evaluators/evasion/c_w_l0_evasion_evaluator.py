...
class CWL0EvasionEvaluator(BaseAttackEvaluator,
    ...
    def evaluate(self, context: EvasionEvaluationContext):
        ...
        evaluation_results = {
            ...
            # Per-sample predicted classes, before and after the attack, so the log shows
            # exactly which samples flipped and to what (aligned with the sample order).
            "original_predictions": clean_predictions.tolist(),
            "perturbed_predictions": adversarial_predictions.tolist(),
        }
