...
class CWL0EvasionVisualizer(BaseVisualizer,
    ...
    def _plot_example(self, ctx, out_dir):
        ...
        fig.suptitle(f"C&W L0 evasion ({mode})", fontsize=14, fontweight='bold')
    ...
    def _plot_l0_distribution(self, ctx, out_dir):
        ...
        ax.set_title("C&W L0 distribution (pixels modified per example)",
