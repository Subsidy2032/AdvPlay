Prompt injection is an LLM attack strategy where the attacker tries to craft input that will cause the LLM to reveal sensitive information or produce output against its guidelines.
